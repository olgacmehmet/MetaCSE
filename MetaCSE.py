...
class Application(tk.Frame):
    ...
    def checkUpdate(self):
        resp = {'message': ''}
        url = "https://api.github.com/repos/Polylanger/MetaCSE/releases/latest"
        try:
    ...
    def initSearchFrame(self):
        ...
        # 信息处理
        self.log_insert(
            f"@ Version: {VERSION}\n@ Author: Polylanger\n@ Repo: https://github.com/Polylanger/MetaCSE\n")
...
https://hunter.qianxin.com/"""
    ...
    def run(self):
        ...
        # fofa
            ...
            if self.query_mode_choice.get() in ["个人信息", "Account"]:
                text = fofa_resource.fofa_search_resource(api_key=self.dic['fofa_api'])
...
if __name__ == '__main__':
    ...
    # root.iconbitmap('image\metamse.ico')
    root.resizable(True, False)
    root.title(f'MetaCSE {VERSION}  --Polylanger')
